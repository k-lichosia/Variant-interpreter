...
**Variant Interpreter** is a Python-based tool that integrates Large Language Models (LLMs) with genomic data analysis. The system automates the process of genetic variant interpretation by translating bioinformatic data into clinical-grade reports using a Retrieval-Augmented Generation (RAG) architecture.
